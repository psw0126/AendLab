...
class StoreTransPage extends StatefulWidget {
  @override
  _StoreTransPageState createState() => _StoreTransPageState();
}

class _StoreTransPageState extends State<StoreTransPage> {
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(
                            child: Text('합계', style: TextStyle(color: Colors
                                .white))),
                      ),
                      Container(
  ...
  Future<void> Handlist() async {
    ...
    http.Response response = await http.get(Uri.http(URL, 'v1/hand/list', params),
        headers: {
