...
class CashReturnTransPage extends StatefulWidget {
  @override
  _CashReturnTransPageState createState() => _CashReturnTransPageState();
}

class _CashReturnTransPageState extends State<CashReturnTransPage> {
      ...
      child: Row(
        ...
        children: [
          InkWell(
            ...
            onTap: () async { SharedPreferences pref = await SharedPreferences.getInstance();
              pref.remove("date");
