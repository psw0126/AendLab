...
class InvenTransPage extends StatefulWidget {
  @override
  _InvenTransPageState createState() => _InvenTransPageState();
}

class _InvenTransPageState extends State<InvenTransPage> {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                          child: Column(
                            children: [
                              Text(ter_qty.toString() + '개'),
                              Text(ter_ppbc.toString() + '원'),
                              Text(ter_spea.toString() + '원')
                            ],
                          )
                      )
                    ],
  ...
  Future Title() async {
    ...
    return pref.getString('InvenTitle');
  }
