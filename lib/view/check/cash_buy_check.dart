...
class CashBuyCheckPage extends StatefulWidget {
  @override
  _CashBuyCheckPageState createState() => _CashBuyCheckPageState();
}

class _CashBuyCheckPageState extends State<CashBuyCheckPage> {
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('현금매입 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('현금매입 조회', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('현금매입 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 20),
                  //     child: Text('현금매입 조회', style: TextStyle(
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  // }else {
                    Modular.to.pushNamed(RouteMap.CASH_TRANSACTION.page);
                  // }
                },
              ),
            ],
    ...
    return Container(
        ...
        child: TypeAheadField<Company?>(
          ...
          onSuggestionSelected: (Company? suggestion) async {
            ...
            pref.setString('CashTitle', company.cname);
