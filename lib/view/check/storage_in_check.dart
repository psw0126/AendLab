...
class StorageInCheckPage extends StatefulWidget {
  @override
  _StorageInCheckPageState createState() => _StorageInCheckPageState();
}

class _StorageInCheckPageState extends State<StorageInCheckPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('창고입고 조회', style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child:
                                  // accessType == "3" ? TerppbcTrue() : accessType == "2" ? TerppbcFalse() : accessType == "1" ? TerppbcTrue() : TerppbcFalse()
                                  TerppbcFalse(),
                                ),
                              ],
                            ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child:
                                  // accessType == "3" ? TerspeaTrue() : accessType == "2" ? TerspeaTrue() : accessType == "1" ? TerspeaFalse() : TerspeaFalse()
                                  TerspeaFalse(),
                                ),
                              ],
                            ),
                              ...
                              children: [
                                ...
                                Pda == true && Phone == false ? Expanded(
                                  child: Container(
                                    ...
                                    child:
                                    // accessType == "3" ? TerppccTrue() : accessType == "2" ? TerppccFalse() : accessType == "1" ? TerppccTrue() : TerppccFalse()
                                    TerppccFalse(),
                                  ),
                              ...
                              children: [
                                ...
                                Pda == true && Phone == false ? Expanded(
                                  child: Container(
                                    ...
                                    child:
                                    // accessType == "3" ? TerspebTrue() : accessType == "2" ? TerspebTrue() : accessType == "1" ? TerspebFalse() : TerspebFalse()
                                    TerspebFalse(),
                                  ),
                                ): Pda == false && Phone == true ? Container(
                                  width: _size.width * 0.32,
                                  ...
                                  child:
                                  // accessType == "3" ? TerspebTrue() : accessType == "2" ? TerspebTrue() : accessType == "1" ? TerspebFalse() :
                                  TerspebFalse(),
                                ) : Container(
                                  width: _size.width * 0.32,
                                  decoration: BoxDecoration(
                              ...
                              try {
                                http.Response response = await http.patch(
                                    ...
                                    body: json.encode({
                                      ...
                                      "ter_type": pref.getString('StorageInType'),
                                ...
                                if(TerqtyController.text == "0") {
                                  alert(context, '수량을 입력해주세요', '확인');
                                } else if (decodeResponse['error'] == "") {
                                  alert(context, '저장완료', '확인', onTap: () {
                                    Modular.to.popAndPushNamed(RouteMap.STORAGE_IN_CHECK.page);
                                  });
                                }
                              } catch (e) {
                                print('에러');
  ...
  Future<void> scanBarcodeNormal() async {
    ...
    var params = {
      ...
      'str_code': '001',
      'date': formatDate,
      'type': pref.getString('StorageInType'),
    ...
    if(decodeResponse[0]['itm_name'] == '미등록상품') {
      return setState(() {
        ...
        if((scanBarcode == TercodeController.text) && (pref.getString('StorageInType') == decodeResponse[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
          showDialog(
              context: context,
    ...
    if((scanBarcode == TercodeController.text) && (pref.getString('StorageInType') == _value[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
      showDialog(
          context: context,
          barrierDismissible: true,
          builder: (BuildContext ctx) {
  ...
  Future<void> handItemList() async {
    ...
    if(decodeResponse[0]['itm_name'] == '미등록상품') {
      return setState(() {
        ...
        if((inputBarcode == TercodeController.text || scanBarcode == TercodeController.text) && (pref.getString('StorageInType') == handvalue[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
          showDialog(
              context: context,
              barrierDismissible: true,
              builder: (BuildContext ctx) {
  ...
  Future<void> itemList() async {
    ...
    print('확인');
    print(decodeResponse);
    print(pref.getString('StorageInType'));
    setState(() {
      this._valueList = decodeResponse;
      // _value = _valueList.map((e) => null);
      _value = _valueList;
    });
  }
