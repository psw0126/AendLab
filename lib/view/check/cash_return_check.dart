...
class CashReturnCheckPage extends StatefulWidget {
  @override
  _CashReturnCheckPageState createState() => _CashReturnCheckPageState();
}

class _CashReturnCheckPageState extends State<CashReturnCheckPage> {
  final TextEditingController _typeAheadController = TextEditingController();
  String? CashReturnCheck;
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('현금반품 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('현금반품 조회', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('현금반품 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 20),
                  //     child: Text('현금반품 조회', style: TextStyle(
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  // }else {
                    Modular.to.pushNamed(RouteMap.CASH_RETRUN_TRANSACTION.page);
                  // }
                },
              ),
            ],
  ...
  //           onTap: () async {
  //             SharedPreferences pref = await SharedPreferences.getInstance();
  //             pref.setString('CashTitle', value['ven_name']);
  //           },
  //         );
  //       }).toList(),
  //     ),
    ...
    return Container(
        ...
        child: TypeAheadField<Company?>(
          ...
          onSuggestionSelected: (Company? suggestion) async {
            ...
            pref.setString('CashReturnTitle', company.cname);
  ...
  Widget Middle(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Text(
            '거래처', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30)),
        Container(
            width: _size.width * 0.65,
            decoration: BoxDecoration(
              color: Colors.white,
