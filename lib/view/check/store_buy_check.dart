...
class StoreBuyCheckPage extends StatefulWidget {
  @override
  _StoreBuyCheckPageState createState() => _StoreBuyCheckPageState();
}

class _StoreBuyCheckPageState extends State<StoreBuyCheckPage> {
  String? StoreBuyCheck;
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('점간매입 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('점간매입 조회', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('점간매입 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 20),
                  //     child: Text('점간매입 조회', style: TextStyle(
              ...
              InkWell(
                ...
                onTap: () async {
                  ...
                  // }else
                    ...
                    Modular.to.pushNamed(RouteMap.STORE_TRANSACTION.page);
                  }
                },
              ),
            ],
