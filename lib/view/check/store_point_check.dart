...
class StorePointCheckPage extends StatefulWidget {
  @override
  _StorePointCheckPageState createState() => _StorePointCheckPageState();
}

class _StorePointCheckPageState extends State<StorePointCheckPage> {
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('점간이동 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('점간이동 조회', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('점간이동 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 20),
                  //     child: Text('점간이동 조회', style: TextStyle(
                ...
                onTap: () {
                  ...
                  if(_value == null){
                    ...
                    Modular.to.pushNamed(
                        RouteMap.STORE_RETRUN_TRANSACTION.page);
                  }
                },
              ),
            ],
