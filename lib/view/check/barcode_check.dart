...
class BarcodeCheckPage extends StatefulWidget {
  @override
  _BarcodeCheckPageState createState() => _BarcodeCheckPageState();
}

class _BarcodeCheckPageState extends State<BarcodeCheckPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('바코드 조회', style: TextStyle(
                                ...
                                print(decodeResponse);
                                 if (decodeResponse['error'] == "") {
                                  alert(context, '저장완료', '확인', onTap: () {
                                    Modular.to.popAndPushNamed(RouteMap.BARCODE_CHECK.page);
                                  });
                                }
                              } catch (e) {
                                print('에러');
