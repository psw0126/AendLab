...
class _OrderCheckPageState extends State<OrderCheckPage> {
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('발주 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('발주 조회', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('발주 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 20),
                  //     child: Text('발주 조회', style: TextStyle(
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  // }else {
                    Modular.to.pushNamed(RouteMap.ORDER_TRANSACTION.page);
                  // }
                },
              ),
            ],
  ...
  Future<void> OrderCheckName() async {
    final SharedPreferences pref = await SharedPreferences.getInstance();
