...
class CreditReturnCheckPage extends StatefulWidget {
  @override
  _CreditReturnCheckPageState createState() => _CreditReturnCheckPageState();
}

class _CreditReturnCheckPageState extends State<CreditReturnCheckPage> {
  String? CreditReturnCheck;
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('외상반품 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('외상반품 조회', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('외상반품 조회', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 20),
                  //     child: Text('외상반품 조회', style: TextStyle(
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  // }else {
                    Modular.to.pushNamed(RouteMap.CREDIT_RETRUN_TRANSACTION.page);
                  // }
                },
              ),
            ],
  ...
  //           onTap: () async {
  //             SharedPreferences pref = await SharedPreferences.getInstance();
  //             pref.setString('CreditReturnTitle', value['ven_name']);
  //           },
  //         );
  //       }).toList(),
  //     ),
    ...
    return Container(
        ...
        child: TypeAheadField<Company?>(
          ...
          onSuggestionSelected: (Company? suggestion) async {
            ...
            pref.setString('CreditReturnTitle', company.cname);
