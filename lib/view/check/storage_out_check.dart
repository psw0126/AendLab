...
class StorageOutCheckPage extends StatefulWidget {
  @override
  _StorageOutCheckPageState createState() => _StorageOutCheckPageState();
}

class _StorageOutCheckPageState extends State<StorageOutCheckPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('창고출고 조회', style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: accessType == "3" ? TerppbcTrue() : accessType == "2" ? TerppbcFalse() : accessType == "1" ? TerppbcTrue() : TerppbcFalse()
                                ),
                              ],
                            ),
                          ),
                              ...
                              try {
                                ...
                                if(TerqtyController.text == "0") {
                                  ...
                                  alert(context, '저장완료', '확인', onTap: () {
                                    Modular.to.popAndPushNamed(RouteMap.STORAGE_OUT_CHECK.page);
                                  });
                                }
                              } catch (e) {
                                print('에러');
