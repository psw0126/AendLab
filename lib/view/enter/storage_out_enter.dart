...
class StorageOutEnterPage extends StatefulWidget {
  @override
  _StorageOutEnterPageState createState() => _StorageOutEnterPageState();
}

class _StorageOutEnterPageState extends State<StorageOutEnterPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('창고출고 입력', style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Pda == true && Phone == false ? Expanded(
                                  ...
                                  child:
                                  // accessType == "3" ? TerppccTrue() : accessType == "2" ? TerppccFalse() : accessType == "1" ? TerppccTrue() :
                                  TerppccFalse(),
                                ) : Container(
                                  width: _size.width * 0.32,
                                  decoration: BoxDecoration(
                              ...
                              try {
                                http.Response response = await http.patch(
                                    ...
                                    body: json.encode({
                                      ...
                                      "ter_type": pref.getString('StorageOutType'),
                                ...
                                if(TerqtyController.text == "0") {
                                  ...
                                  alert(context, '저장완료', '확인', onTap: () {
                                    Modular.to.popAndPushNamed(RouteMap.STORAGE_OUT_ENTER.page);
                                  });
                                }
                              } catch (e) {
                                print('에러');
  ...
  Future<void> scanBarcodeNormal() async {
    ...
    var params = {
      ...
      'str_code': '001',
      'date': formatDate,
      'type': pref.getString('StorageOutType'),
    ...
    if(decodeResponse[0]['itm_name'] == '미등록상품') {
      return setState(() {
        ...
        if((scanBarcode == TercodeController.text) && (pref.getString('StorageOutType') == decodeResponse[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
          showDialog(
              context: context,
    ...
    if((scanBarcode == TercodeController.text) && (pref.getString('StorageOutType') == _value[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
      showDialog(
          context: context,
          barrierDismissible: true,
          builder: (BuildContext ctx) {
  ...
  Future<void> handItemList() async {
    ...
    if(decodeResponse[0]['itm_name'] == '미등록상품') {
      return setState(() {
        ...
        if((inputBarcode == TercodeController.text || scanBarcode == TercodeController.text) && (pref.getString('StorageOutType') == handvalue[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
          showDialog(
              context: context,
              barrierDismissible: true,
              builder: (BuildContext ctx) {
