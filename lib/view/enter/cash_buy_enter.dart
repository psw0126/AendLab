...
class CashBuyEnterPage extends StatefulWidget {
  @override
  _CashBuyEnterPageState createState() => _CashBuyEnterPageState();
}

class _CashBuyEnterPageState extends State<CashBuyEnterPage> {
            ...
            children: [
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('현금매입입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('현금매입입력', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('현금매입입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  // Container(
                  //     margin: EdgeInsets.symmetric(vertical: 30),
                  //     child: Text('현금매입 입력', style: TextStyle(
              ...
              InkWell(
                ...
                onTap: () {
                  ...
                  // }else {
                    Modular.to.pushNamed(RouteMap.CASH_BUY_INPUT.page);
                  // }
                },
              ),
            ],
