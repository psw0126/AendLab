...
class StorePointEnterPage extends StatefulWidget {
  @override
  _StorePointEnterPageState createState() => _StorePointEnterPageState();
}

class _StorePointEnterPageState extends State<StorePointEnterPage> {
  String? StorePointEnter;
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('점간이동 입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('점간이동 입력', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('점간이동 입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
              ...
              InkWell(
                ...
                onTap: (){
                  ...
                  if(_value == null){
                    ...
                    Modular.to.pushNamed(RouteMap.STORE_POINT_INPUT.page);
                  }
                },
              ),
            ],
...
Widget Middle(BuildContext context) {
  ...
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
    children: [
      Text('점포선택', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30)),
      Container(
          width: _size.width*0.65,
          decoration: BoxDecoration(
            color: Colors.white,
...
Future<void> StrPointName() async {
  final SharedPreferences pref = await SharedPreferences.getInstance();
