...
class CreditReturnEnterPage extends StatefulWidget {
  @override
  _CreditReturnEnterPageState createState() => _CreditReturnEnterPageState();
}

class _CreditReturnEnterPageState extends State<CreditReturnEnterPage> {
  final TextEditingController _typeAheadController = TextEditingController();
  String? CreditReturnEnter;
            ...
            children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('외상반품입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('외상반품입력', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('외상반품입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
              ...
              InkWell(
                ...
                onTap: (){
                  ...
                  // }else {
                    Modular.to.pushNamed(RouteMap.CREDIT_RETRUN_INPUT.page);
                  // }
                },
              ),
            ],
