...
class StorageInEnterPage extends StatefulWidget {
  @override
  _StorageInEnterPageState createState() => _StorageInEnterPageState();
}

class _StorageInEnterPageState extends State<StorageInEnterPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('창고입고 입력', style: TextStyle(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child:
                                  // accessType == "3" ? TerppbcTrue() : accessType == "2" ? TerppbcFalse() : accessType == "1" ? TerppbcTrue() :
                                  TerppbcFalse(),
                                ),
                              ],
                            ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child:
                                  // accessType == "3" ? TerspeaTrue() : accessType == "2" ? TerspeaTrue() : accessType == "1" ? TerspeaFalse() :
                                  TerspeaFalse(),
                                ),
                              ],
                            ),
                              ...
                              try {
                                ...
                                if(TerqtyController.text == "0") {
                                  ...
                                  alert(context, '저장완료', '확인', onTap: () {
                                    Modular.to.popAndPushNamed(RouteMap.STORAGE_IN_ENTER.page);
                                  });
                                }
                              } catch (e) {
                                print('에러');
  ...
  Future<void> handItemList() async {
    ...
    setState(() {
      ...
      // if((TertaxController.text = handvalue[0]['itm_tax'].toString()) == "1"){
