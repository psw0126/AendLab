...
class CashReturnEnterPage extends StatefulWidget {
  @override
  _CashReturnEnterPageState createState() => _CashReturnEnterPageState();
}

class _CashReturnEnterPageState extends State<CashReturnEnterPage> {
  final TextEditingController _typeAheadController = TextEditingController();
  String? CashReturnEnter;
            ...
            children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('현금반품 입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('현금반품 입력', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('현금반품 입력', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
              ...
              InkWell(
                ...
                onTap: (){
                  ...
                  // }
                  // else {
                    Modular.to.pushNamed(RouteMap.CASH_RETURN_INPUT.page);
                  // }
                },
              ),
            ],
...
Widget Middle(BuildContext context) {
  ...
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
    children: [
      Text('거래처', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30)),
      Container(
          width: _size.width*0.65,
          decoration: BoxDecoration(
            color: Colors.white,
