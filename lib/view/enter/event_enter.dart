...
class EventEnterPage extends StatefulWidget {
  @override
  _EventEnterPageState createState() => _EventEnterPageState();
}

class _EventEnterPageState extends State<EventEnterPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('행사 입력', style: TextStyle(
                    ...
                    Container(
                        child: FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            return snapshot.data != null ? SizedBox(height: 1): SizedBox(height: 1);
                          },
                        )
                    ),
                    Container(
                          ...
                          Container(
                              ...
                              child:  (Pda == true && Phone == false) ? RawKeyboardListener(
                                ...
                                child: TextField(
                                  ...
                                  onSubmitted: (value) {
                                    handItemList();
                                    accessOption == "2" || accessOption == "0" ? FocusScope.of(context).requestFocus(_terspebNode) : FocusScope.of(context).requestFocus(_terppccNode);
                                ...
                                Pda == true && Phone == false ? Expanded(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      child: accessOption == "2" || accessOption == "0" ? TerppccFalse() : accessOption == "1" || accessOption == "3" ? TerppccTrue() : TerppccTrue()
                                  ),
                              ...
                              children: [
                                ...
                                Pda == true && Phone == false ? Expanded(
                                  child: Container(
                                    ...
                                    child: accessOption == "2" || accessOption == "0" ? TerspebTrue() : accessOption == "1" || accessOption == "3" ? TerspebTrue() : TerspebTrue()
                                  ),
                                ) : Pda == false && Phone == true ? Container(
                                    width: _size.width * 0.30,
                                    decoration: BoxDecoration(
                                ...
                                print(decodeResponse);
                                 if (decodeResponse['error'] == "") {
                                  alert(context, '저장완료', '확인', onTap: () {
                                    Modular.to.popAndPushNamed(RouteMap.EVENT_ENTER.page);
                                  });
                                }
                              } catch (e) {
                                print('에러');
  ...
  Future<void> scanBarcodeNormal() async {
    ...
    if(decodeResponse[0]['itm_name'] == '미등록상품') {
      return setState(() {
        ...
        accessOption == "2" || accessOption == "0" ? TerspebController.selection = TextSelection(baseOffset: TerspebController.text.length, extentOffset: 0) : TerppccController.selection = TextSelection(baseOffset: TerppccController.text.length, extentOffset: 0);
        ...
        // if((scanBarcode == TercodeController.text) && (pref.getString('EventType') == decodeResponse[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
        //   showDialog(
        //       context: context,
    ...
    setState(() {
      ...
      accessOption == "2" || accessOption == "0" ? TerspebController.selection = TextSelection(baseOffset: TerspebController.text.length, extentOffset: 0) : TerspebController.selection = TextSelection(baseOffset: TerppccController.text.length, extentOffset: 0);
    ...
    // if((scanBarcode == TercodeController.text) && (pref.getString('EventType') == _value[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
    //   showDialog(
    //       context: context,
    //       barrierDismissible: true,
    //       builder: (BuildContext ctx) {
  ...
  Future<void> handItemList() async {
    ...
    if(decodeResponse[0]['itm_name'] == '미등록상품') {
      return setState(() {
        ...
        // if((inputBarcode == TercodeController.text || scanBarcode == TercodeController.text) && (pref.getString('EventType') == handvalue[0]['itm_type'].toString()) && (TerqtyController.text != 0.toString())) {
        //   showDialog(
        //       context: context,
        //       barrierDismissible: true,
        //       builder: (BuildContext ctx) {
