...
class EventPage extends StatefulWidget {
  String EventType = '';
  EventPage({Key? key, required this.EventType}) : super(key: key);
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('행사 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('행사 메뉴', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('행사 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      final SharedPreferences pref = await SharedPreferences.getInstance();
                      pref.setString('EventType', widget.EventType);
                      print('확인');
                      print(pref.getString('EventType'));
                      Modular.to.pushNamed(RouteMap.EVENT_ENTER.page);
                    },
                  ),
                  InkWell(
                    child: Container(
                    ...
                    onTap: () async {
                      ...
                      print('확인');
                      print(pref.getString('EventType'));
                      Modular.to.pushNamed(RouteMap.EVENT_CHECK.page);
                    },
                  ),
                ],
              ),
