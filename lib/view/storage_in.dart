...
class StorageInPage extends StatefulWidget {
  String StorageInType = '';
  StorageInPage({Key? key, required this.StorageInType}) : super(key: key);

  @override
  _StorageInPageState createState() => _StorageInPageState();
}

class _StorageInPageState extends State<StorageInPage> {
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('창고입고 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('창고입고 메뉴', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('창고입고 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      final SharedPreferences pref = await SharedPreferences.getInstance();
                      pref.setString('StorageInType', widget.StorageInType);
                      print('확인');
                      print(pref.getString('StorageInType'));
                      Modular.to.pushNamed(RouteMap.STORAGE_IN_ENTER.page);
                    },
                  ),
                  InkWell(
                    child: Container(
                    ...
                    onTap: () async {
                      ...
                      print('확인');
                      print(pref.getString('StorageInType'));
                      Modular.to.pushNamed(RouteMap.STORAGE_IN_CHECK.page);
                    },
                  ),
                ],
              ),
