...
class BarcodePage extends StatefulWidget {
  String BarcodeType = '';
  BarcodePage({Key? key, required this.BarcodeType}) : super(key: key);
              ...
              Column(
                children: [
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          return Pda == true && Phone == false ? Container(
                            ...
                            child: Text('바코드 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          ) : Pda == false && Phone == true ? Container(
                            margin: EdgeInsets.symmetric(vertical: 30),
                            child: Text('바코드 메뉴', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                          ) : Container(
                            margin: EdgeInsets.symmetric(vertical: 20),
                            child: Text('바코드 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                          );
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      final SharedPreferences pref = await SharedPreferences.getInstance();
                      pref.setString('BarcodeType', widget.BarcodeType);
                      print('확인');
                      print(pref.getString('BarcodeType'));
                      Modular.to.pushNamed(RouteMap.BARCODE_ENTER.page);
                    },
                  ),
                  InkWell(
                    child: Container(
                    ...
                    onTap: () async {
                      ...
                      print('확인');
                      print(pref.getString('BarcodeType'));
                      Modular.to.pushNamed(RouteMap.BARCODE_CHECK.page);
                    },
                  ),
                ],
              ),
