...
class CreditPage extends StatefulWidget {
  String CreditType = '';
  CreditPage({Key? key, required this.CreditType}) : super(key: key);
                  ...
                  Column(
                    children: [
                          ...
                          child: FutureBuilder(
                            ...
                            builder: (context, snapshot) {
                              return Pda == true && Phone == false ? Container(
                                ...
                                child: Text('외상매입 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                              ) : Pda == false && Phone == true ? Container(
                                margin: EdgeInsets.symmetric(vertical: 30),
                                child: Text('외상매입 메뉴', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
                              ) : Container(
                                margin: EdgeInsets.symmetric(vertical: 20),
                                child: Text('외상매입 메뉴', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                              );
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          final SharedPreferences pref = await SharedPreferences.getInstance();
                          pref.setString('CreditType', widget.CreditType);
                          print('확인');
                          print(pref.getString('CreditType'));
                          Modular.to.pushNamed(RouteMap.CREDITENTER.page);
                        },
                      ),
                      InkWell(
                        child: Container(
                        ...
                        onTap: () async {
                          ...
                          print('확인');
                          print(pref.getString('CreditType'));
                          Modular.to.pushNamed(RouteMap.CREDITECHECK.page);
                        },
                      ),
                    ],
                  ),
